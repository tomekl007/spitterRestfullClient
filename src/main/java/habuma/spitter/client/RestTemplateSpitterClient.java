...
////        "http://localhost:8080/mainP/Spitter/spitters/{spitter}/spittles", 
////        Spittle[].class, username);
////    
...
//    return rest.postForObject("http://localhost:8080/mainP/Spitter/spitters", 
...
//            "http://localhost:8080/Spitter/mainP/spitters", 
...
//  }
  ...
  public static void main(String[] args) {
    RestTemplate rest = new RestTemplate();
    ResponseEntity<String> response = rest.getForEntity("http://localhost:8080/mainP/Spitter/spitters", String.class);
    System.out.println(response.getBody());
    
    MultiValueMap<String, String> headers = new LinkedMultiValueMap<String, String>();
    headers.add("Accept", "text/xml");
    HttpEntity<Object> request = new HttpEntity<Object>(headers );
    ResponseEntity<String> entity = rest.exchange("http://localhost:8080/mainP/Spitter/spitters", HttpMethod.GET, request, String.class);
